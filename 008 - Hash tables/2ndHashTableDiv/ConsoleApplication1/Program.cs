...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            OurHashTable theHashTable = new OurHashTable(27); // hash TABLE is size 27
            
           
            
            // allowed key range is 1 to 20, since that's how many unique items we might store from our string dataArray

            // hash algo takes specified number of entries (12)  with keys from 0 thru 19 and hashes into one of our slots, 0 thru 26

            int howMany = 12;  // we will try and fit 12 entries into this table of size 27
